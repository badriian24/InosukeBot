...
module.exports = {
  ...
  aliases: [],
    ...
    if (!item) {
              ...
              .setColor("RED")
              .setDescription(`${client.emotes.error} **${member.user.username}** | You can't sell this item.`);
    ...
    if (!founditem) {
              ...
              .setColor("RED")
              .setDescription(`${client.emotes.error} **${member.user.username}**  | You dont have this item.`);
    ...
    if (args[1] == 'all' || args[2] == 'all') {
        ...
        const embed = new MessageEmbed()
            .setDescription(`${client.emotes.yes} **${member.user.username}** : You sold ${parseInt(sellAmount/item.sellAmount).toLocaleString()} **${item.name}** for \`${(sellAmount).toLocaleString()}\` coins.`)
    ...
    if (founditem.amount < parseInt(sellAmount)) {
              ...
              .setColor("RED")
              .setDescription(`${client.emotes.error} **${member.user.username}** | You only have x **${founditem.amount}** of this item`);
    ...
    await user.save();
    const embed = new MessageEmbed()
        .setDescription(`${client.emotes.yes} **${member.user.username}** : You sold **${item.name}** x **${parseInt(sellAmount).toLocaleString()}** for \`${parseInt(item.sellAmount * sellAmount).toLocaleString()}\` coins`)
        .setColor(client.embedcolor);
